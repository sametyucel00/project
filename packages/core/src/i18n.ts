...
export const dictionary: Record<Locale, Record<string, string>> = {
  tr: {
    appName: "Nar Rehberi",
    searchPlaceholder: "Mekan, etkinlik, fÄ±rsat ara",
    login: "Tek GiriÅŸ",
    back: "Geri",
    homeTab: "Ana Sayfa",
    placesTab: "Mekanlar",
    eventsTab: "Etkinlikler",
    offersTab: "FÄ±rsatlar",
    profileTab: "Profil",
    unspecified: "BelirtilmemiÅŸ",
    lightMode: "AÃ§Ä±k Mod",
    darkMode: "Koyu Mod",
    systemMode: "Sistem temasÄ±",
    touristSurvivalKit: "Tourist Survival Kit",
    ancientGuide: "Antik Rehber",
    onboardingTitle: "Nar Rehberi'ne hoÅŸ geldin",
    onboardingSubtitle: "Şehrini keşfetmek için dili seç, istersen konum desteğini aç ve başlayalım.",
    onboardingContinue: "BaÅŸla",
    onboardingAllowLocation: "Devam et",
    onboardingSkipLocation: "Åimdilik atla",
    onboardingLanguage: "Dil seÃ§imi",
    onboardingSplashTagline: "Åehir keÅŸfi, mekanlar ve etkinlikler tek yerde.",
    ...
    onboardingLocaleBody: "Cihaz dilin uygunsa uygulama o dile gÃ¶re baÅŸlar ve sonradan deÄŸiÅŸtirilebilir.",
    onboardingLocationGranted: "Konum izni verildi",
    onboardingLocationReady: "Konum izni hazÄ±r.",
  ...
  en: {
    ...
    onboardingAllowLocation: "Continue",
  ...
  de: {
    ...
    onboardingSkipLocation: "Jetzt Ã¼berspringen",
